...
public class AddToCartServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            String roomID = request.getParameter("cbChooseRoom");
            ...
            if (date1.compareTo(date2) <= 0) {
                ...
                cart.addItem(roomID, room.getRoomType(), quantity, room.getPrice(), hotelName, checkInDate, checkOutDate, (day/86400000) + 1);
            ...
            log("AddToCartServlet_Naming_" + ex.getMessage());
        } catch (ParseException ex) {
            log("AddToCartServlet_Parse_" + ex.getMessage());
        } finally {
