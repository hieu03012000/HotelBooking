    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (id != null) {
                ...
                int percent = dao.getDiscount(id);
                if (percent > 0) {
                    HttpSession s = request.getSession();
                    s.setAttribute("DISCOUNT", percent);
                    request.setAttribute("GET_DISCOUNT", "Get dis ount " + percent + "% success");
                } else {
                    request.setAttribute("GET_DISCOUNT", "Do not have code discount");
                }
            }
